...
const Canvas = ({color='#0066ff', angle=120, text="2,358"}) => {
  ...
  return (
    <Card className=' justify-center'>
      <CardBody className='h-[275px] rounded-2xl items-center justify-center flex'>
        <div className='flex-col'>
          <h4 className='text-black text-xl font-medium text-center mb-3'>Total Application</h4>
