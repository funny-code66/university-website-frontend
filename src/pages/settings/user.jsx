    ...
    <div className="mt-12 w-full bg-[#E8E9EB] px-14 my-20 flex flex-col gap-8">
        ...
        >
            <div className="w-full flex">
                {title.map((item) => (
                    <NavLink className= 'text-left text-2xl text-[#92929D] ml-8 hover:border-t-4 border-[#280559]' color="blue-gray">
                        {item.name}
                    </NavLink> 
                ))}
          </div>
            ...
            <div className="flex flex-row gap-6">
                <NavLink to="User">
                    <div className="flex flex-col items-center">
                        <div className="absolute top-0 w-[50px] h-1 bg-[#280559]  "/>
                        <p className="text-[24px] text-[#280559] font-semibold">User</p>
                    </div>
                </NavLink>
                <NavLink to="Branch">
        ...
        <Card>
            ...
            <div className=" pl-12 rounded-lg flex w-full justify-between">
                ...
                <Button variant="outlined" className=" focus:ring-2 ring-offset-current outline-white flex justify-center items-center ml-2 w-30">
                    <img className=" justify-between items-start" src={Vector} alt='Vector'/> 
                    <span className="ml-1 text-[#280559] px-2">Filters</span>
                </Button>
            </div>
            </CardBody>
