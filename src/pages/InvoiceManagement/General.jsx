                ...
                <div className="relative bg-white flex flex-row justify-between items-center p-12 mb-7   rounded-[34px]">
                    ...
                    <NavLink to="Commission">
                        <div className="flex flex-col items-center">
                            {/* <div className="absolute top-0 w-[237px] h-1 bg-[#280559]"/> */}
                            <p className="text-[33px] text-[#92929D] font-semibold">Commission Invoice</p>
                        </div>
                    </NavLink>
                    <NavLink to="general">
                        <div className="flex flex-col items-center">
                            <div className="absolute top-0 w-[237px] h-1 bg-[#280559]"/>
                            <p className="text-[33px] text-[#280559]  font-semibold">General Invoice</p>
                        </div>
                    </NavLink>
                    </div>
                </div>
