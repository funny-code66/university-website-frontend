    ...
    <div className=" mt-12 w-full bg-[#E8E9EB] px-14 my-20 flex flex-col gap-8">
        ...
        >
            <div className="w-full flex">
                {title.map((item) => (
                    <NavLink to='/cost' className='text-left text-2xl text-[#92929D] ml-8 hover:border-t-4 border-[#280559]' color="blue-gray">
                        {item.name}
                    </NavLink> 
                ))}
          </div>
            ...
            <div className="flex flex-row gap-6">
                <NavLink to="Reports">
                    <div className="flex flex-col items-center">
                        <div className="absolute top-0 w-[150px] h-1 bg-[#280559] "/>
                        <p className="text-[24px] text-[#280559] font-semibold">Balance Sheet</p>
                    </div>
                </NavLink>
                <NavLink to="profit">
                ...
                <NavLink to="reportsCost">
                    <div className="flex flex-col items-center">
                        <div className="absolute top-0 w-[237px] h-1 bg-[#280559] hidden"/>
                        <p className="text-[24px] text-[#92929D] font-semibold">Cost Of Sale</p>
                    </div>
                </NavLink>
            </div>
        </div> 
        ...
        <Card>
            ...
            <div className="w-full flex max-md:flex-col">
                    <Typography href='/#' className= 'mb-[54px] w-full flex justify-between space-x-3 text-[#92929D] ml-8 ' variant="h5" color="blue-gray">
                        <p className="text-[#280559] text-[36px] text-center">Balance Sheet</p> 
                    ...
                    <div className="p-1.5 w-full inline-block align-middle">
                        <div className="overflow-hidden border-none rounded-lg">
                            <table className="w-full divide-y divide-gray-200">
                                ...
                                <div className="mb-3 mt-3 flex w-full items-center">
                                    <h3 className="text-left text-lg font-semibold text-[#333333]">Total current assets</h3>
                                </div> 
                                <div className="mb-3 mt-3 flex w-full justify-between items-center">
                                    <h3 className=" text-xl font-semibold text-[#333333]">Total Assets</h3>
                                    <h3 className=" text-xl font-semibold text-[#333333]">$1,217.00</h3>
                                </div> 
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div className="p-1.5 w-full inline-block align-middle">
                        <div className="overflow-hidden border-none rounded-lg">
                            <table className="w-full divide-y divide-gray-200">
                                ...
                                <div className="mb-3 mt-3 flex w-full items-center">
                                    <h3 className="text-left text-lg font-semibold text-[#333333]">Shareholder's Equity</h3>
                                </div>  
                                <tbody className="divide-y divide-gray-200">
                                    {Currency.map((items) => (
                                    <tr>
                                ...
                                <div className="mb-3 mt-3 flex w-full items-center">
                                    <h3 className="text-left text-lg font-semibold text-[#333333]">Total Shareholder's Equity</h3>
                                </div> 
                                <div className="mb-3 mt-3 flex w-full justify-between items-center">
                                    <h3 className=" text-xl font-semibold text-[#333333]">Total Equity</h3>
                                    <h3 className=" text-xl font-semibold text-[#333333]">$699.00</h3>
                                </div> 
                                </tbody>
                            </table>
                        </div>
