            ...
            <div className="flex flex-row gap-6">
                ...
                <NavLink to="profit">
                    <div className="flex flex-col items-center border-[#280559] ">
                        <div className="absolute top-0 w-[120px] h-1 bg-[#280559]  "/>
                        <p className="text-[24px] text-[#280559] font-semibold">Profit Loss</p>
                    </div>
                </NavLink>
                <NavLink to="income">
                    <div className="flex flex-col items-center">
        ...
        <Card>
            ...
            <div className="w-full flex max-md:flex-col">
                    <Typography href='/#' className= 'mb-[54px] w-full flex justify-between space-x-3 text-[#92929D] ml-8 ' variant="h5" color="blue-gray">
                        <p className="text-[#280559] text-[36px] text-center">Profit Loss Statement</p> 
                    </Typography>
            </div>
