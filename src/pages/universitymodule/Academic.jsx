                ...
                <div className="relative bg-white flex flex-row justify-between items-center p-12 mb-7   rounded-[34px]">
                    ...
                    <NavLink to="university">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-[24px] text-[#92929D] font-semibold">University</p>
                        </div>
                    </NavLink>    
                        <div className="flex flex-col items-center">
                            <div className="absolute top-0 w-[220px] h-1 bg-[#280559]"/>
                            <p className="text-[24px] text-[#280559] font-semibold">Academic Programs</p>
                        </div>
                    </div>
                </div>
                <div className=" bg-white p-12 rounded-[34px]">
                    <div className=" w-full flex flex-row justify-between py-5 my-3">
                        <p className="text-[32px] text-black font-bold">Academic</p>
                        <NavLink to="createAcademic">
                            ...
                            <p className="m-1 text-base text-white font-medium normal-case">Add New Programs</p>
                            </Button>
                        </NavLink>
                    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {UniversityModul_acardemic_data.map((items) => (
                            <tr>
