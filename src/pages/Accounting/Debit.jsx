        ...
        <div className="mt-12 w-full bg-[#E8E9EB] px-14">
            ...
            <div className="relative bg-white flex flex-row justify-between items-center p-12 mb-7   rounded-[34px]">
                    <div className="flex flex-row gap-6">
                        ...
                        <Link to="debit">
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-[24px] text-[#280559] font-semibold">Debit & Credit</p>
                            </div>
                        </Link>
                        <Link to="expenses">
                            <div className="flex flex-col items-center">
                ...
                <div className=" bg-white p-12 rounded-[34px]">
                    ...
                    <div className="flex flex-row justify-between border-t-2 border-[#D9D9D9] py-5 px-7">
                        <div>
                            <p className="text-[#333333] text-[22px] font-semibold"> Total Cost </p>
                        </div>
                        <div className="flex flex-row gap-28 ">
                            <p className="text-[#333333] text-[22px] font-semibold"> $353.00 </p>
                            <p className="text-[#333333] text-[22px] font-semibold"> $1,470.00 </p>
                        </div>
                    </div>
                </div>
            </div>
