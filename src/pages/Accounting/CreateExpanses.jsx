...
export function CreateExpanses() {
        ...
        <div className="mt-12 w-full bg-[#E8E9EB] px-14">
            ...
            <div className="relative bg-white flex flex-row justify-between items-center p-12 mb-7   rounded-[34px]">
                    <div className="flex flex-row gap-6">
                        ...
                        <Link to="expenses">
                            <div className="flex flex-col items-center">
                                <div className="absolute top-0 w-[112px] h-1 bg-[#280559] "/>
                                <p className="text-[24px] text-[#280559] font-semibold ">Expanses</p>
                            </div>
                        </Link>
                        <Link to="sales">
                            <div className="flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 my-10">
                <p className=" text-4xl font-semibold text-[#280559]">Create Expanses</p>
                <p className=" text-base font text-[#9898A3]">Create or edit Expanses</p>
            </div>
            <div className="bg-white rounded-[34px] p-[39px] my-[30px]">

                <p className="text-[#333333] text-2xl font-semibold my-8">Expanses Details</p>
                <div className="grid grid-cols-3 gap-[30px]">
                    <div>
                        <p className=" text-base font-semibold my-4">Expanses Name</p>
                        <Input className="h-[57px]" label="Expanses Name"></Input>
                    </div>
                    <div>
